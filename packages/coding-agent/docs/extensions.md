...
| Package | Purpose |
|---------|---------|
| `asuka.pi` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "asuka.pi";
...
```typescript
import { isBashToolResult } from "asuka.pi";
...
```typescript
import { createLocalBashOperations } from "asuka.pi";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "asuka.pi";
...
```typescript
import { SessionManager } from "asuka.pi";
...
```typescript
import { withFileMutationQueue } from "asuka.pi";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "asuka.pi";
...
```typescript
import { createBashTool } from "asuka.pi";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "asuka.pi";
...
```typescript
import { highlightCode, getLanguageFromPath } from "asuka.pi";
