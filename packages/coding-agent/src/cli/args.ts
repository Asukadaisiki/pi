...
${chalk.bold("Examples:")}
  ...
  ${APP_NAME} --models gpt-5.5,deepseek-v4-flash,kimi-k2.6

  # Limit to a specific provider with glob pattern
  ${APP_NAME} --models "openai/*"

  # Cycle models with fixed thinking levels
  ${APP_NAME} --models gpt-5.5:high,deepseek-v4-flash:low
...
${chalk.bold("Environment Variables:")}
  OPENAI_API_KEY                   - API key used by the in-memory default config
  Provider credential variables   - Declared in config.json through auth.env/auth.bearerEnv
